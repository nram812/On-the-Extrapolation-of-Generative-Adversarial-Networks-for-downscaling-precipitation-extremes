...
# code directory
cd /nesi/project/niwa03712/queenle/ML_emulator/code/applying_ml_model/v3
# Base path
...
output_dir='/nesi/nobackup/niwa03712/ML_Downscaled_CMIP6/'
...
/nesi/project/niwa00018/queenle/ml_env_v2/bin/python3 run_emulator_v3.py "GAN" $5 $GCM_string_name $OUTPUT_FILENAME_imperfect "imperfect_emulator"
...
/nesi/project/niwa00018/queenle/ml_env_v2/bin/python3 run_emulator_v3.py "GAN" $5 $GCM_string_name $OUTPUT_FILENAME_perfect "perfect_emulator"
